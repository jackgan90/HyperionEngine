...
Editor SHALL show the active PRS overlay for an available Outliner-selected object in the editor view. X/Y/Z handles SHALL use red/green/blue, with a highlighted hovered or active handle, and SHALL be clipped to the viewport image. This capability SHALL NOT add object highlighting or viewport object picking.

# fullscreen-render-passes Specification

## Purpose
Define reusable Renderer-owned fullscreen triangle passes with explicit inputs, targets, graphics state, frozen parameters and retained resources.
## Requirements

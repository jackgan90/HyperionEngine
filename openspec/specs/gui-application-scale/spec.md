# gui-application-scale Specification

## Purpose
Provide application-wide GUI scaling with clear fonts, stable live adjustment, persistent preferences and safe retained rendering resources.
## Requirements

# asset-editor-window Specification

## Purpose
Define the independent native asset editor window, its coexistence with the scene viewport, window-local input and protected presentation and document lifecycles.
## Requirements

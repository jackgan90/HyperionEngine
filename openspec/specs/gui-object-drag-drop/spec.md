# gui-object-drag-drop Specification

## Purpose
Define engine-owned GUI drag-and-drop payloads, delivery and cancellation, plus clipped textured overlays that preserve input, resource and rendering boundaries.
## Requirements

# editable-model-instances Specification

## Purpose
Define whole-model scene references, stable subresource identities, instance overrides and explicit asset migrations that preserve authored content.

# hierarchical-depth Specification

## Purpose
Define consumer-requested compute depth pyramids with conservative mip reduction, both depth conventions and current-view resource lifetime guarantees.
## Requirements

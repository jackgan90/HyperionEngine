...
## Purpose
Define registered CPU scene components with stable identities, validated Main-thread transactions and versioned persistence independent of rendering and editor code.

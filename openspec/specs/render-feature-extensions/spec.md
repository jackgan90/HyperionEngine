# render-feature-extensions Specification

## Purpose
Define optional rendering contributions through named stages, explicit RenderGraph resource contracts, and startup-fixed feature registration.
## Requirements

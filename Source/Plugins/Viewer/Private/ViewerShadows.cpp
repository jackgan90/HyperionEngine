...
void FViewerPlugin::InitializeShadowSettings()
{
	ShadowSettings = Options.Shadows;
}

FSceneInstance* FViewerPlugin::GetSceneInstance()
{
	return ScenePlugin ? &ScenePlugin->GetSceneInstance() : ModelPlugin ? &ModelPlugin->GetSceneInstance() : nullptr;
}

void FViewerPlugin::SetSceneLightDirection(FVec3 InDirection)
{
...
void FViewerPlugin::UpdateShadowLight(int InFrame)
{

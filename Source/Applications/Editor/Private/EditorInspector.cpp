...
namespace Hyperion
{
bool FEditorApplication::DrawComponent(const FSceneNodeView& InView, const FSceneComponent& InComponent,
...
void FEditorApplication::DrawComponentInspector(const FSceneNodeView& InView)
{
	const auto& Node = *InView.Node;

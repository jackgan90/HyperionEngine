...
void FEditorApplication::ExerciseViewHistory()
{
...
void FEditorApplication::ExerciseViewPreview(std::vector<FInputEvent>& InEvents)
{
...
void FEditorApplication::ExerciseViewInput(std::vector<FInputEvent>& InEvents)
{

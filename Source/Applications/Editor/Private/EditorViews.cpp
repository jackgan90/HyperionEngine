...
namespace Hyperion
{
void FEditorApplication::SetPreviewCamera(std::optional<FSceneHandle> InHandle)
{
	if (InHandle)
	{
		if (HasDrafts())
...
void FEditorApplication::ApplyEditorView(FSceneHandle InHandle)
{
...
void FEditorApplication::CreateCameraFromView()
{
...
void FEditorApplication::DrawViewControls()
{
	try
	{
...
void FEditorApplication::DrawCameraActions(FSceneHandle InHandle)
{
